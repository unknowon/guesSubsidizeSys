...
<article class="page-container">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath%>/SuperNextLevel/superNextLevelEdit.do" class="form form-horizontal" id="form-add">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#btnSave").click(function(){
            ...
            $.ajax({
                url:"<%=ctxPath%>/SuperNextLevel/superNextLevelEdit.do",type:"post",
                data:data,
