...
<article class="page-container">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath%>/SuperNextLevel/superNextLevelAdd.do" class="form form-horizontal" id="form-add">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#btnSave").click(function(){
            ...
            $.ajax({
                url:"<%=ctxPath%>/SuperNextLevel/superNextLevelAdd.do",type:"post",
                data:data,
