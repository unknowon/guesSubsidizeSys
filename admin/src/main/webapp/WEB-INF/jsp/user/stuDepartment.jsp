                        ...
                        <form onsubmit="ajaxSubmitForm(this,true)" action="<%=ctxPath%>/User/stuDepartment.do" class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="inputPost2" placeholder="请填写部门所在地邮政编码" value="${inputPost2}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputTel3" class="col-sm-2 control-label">联系电话</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="inputTel3" placeholder="请填写部门联系电话" value="${inputTel3}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputAdd2" class="col-sm-2 control-label">民政部分地址</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="inputAdd2" placeholder="请填写部门地址" value="${inputAdd2}">
                                    </div>
                                </div>
