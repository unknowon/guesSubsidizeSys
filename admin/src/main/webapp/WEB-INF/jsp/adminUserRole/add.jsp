...
<article class="page-container">
    <form  onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath%>/AdminUserRole/adminUserRoleAdd.do" class="form form-horizontal" id="form-add">
        ...
        <div class="col-md-6 col-xs-12">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" id="adminUserId" name="adminUserId" placeholder="输入用户名">
                </div>
                <div class="row cl">
