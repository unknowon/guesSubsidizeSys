        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="col-xs-2">
                <button type="button" class="btn btn-block btn-primary" href="javascript:;" onclick="admin_add('添加用户','<%=ctxPath%>/ShuJiNextLevel/shuJiNextLevelAdd.do','800','500')">添加用户</button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
