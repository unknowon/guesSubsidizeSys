...
<article class="page-container">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath%>/Class/classEdit.do" class="form form-horizontal" id="form-add">
        <input type="hidden" name="id" value="${clz.id }"/>

        <div class="col-md-6 col-xs-12">
            <div class="box-body">
                <div class="form-group">
                    <label for="name"><span class="c-red">*</span>班级名称：</label>
                    <input type="text" class="form-control" value="${clz.name}" id="name" name="name" placeholder="输入班级名称">
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-5">
                        <select id="collegeId" name="collegeId" datatype="*" >
                            ...
                            <option value="${nowClassCollege.id }">${nowClassCollege.name}</option>
